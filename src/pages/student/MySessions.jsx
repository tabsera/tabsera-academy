      ...
      {credits?.summary && (
        <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl p-6 text-white mb-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            {credits.summary.totalCreditsReserved > 0 && (
              <div className="text-center">
                <p className="text-indigo-100 text-sm">Reserved (Recurring)</p>
                <p className="text-2xl font-semibold">{credits.summary.totalCreditsReserved}</p>
              </div>
            )}
