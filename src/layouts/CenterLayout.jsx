...
import {
  ...
  Settings, Bell, Menu, X, LogOut, BookOpen, BarChart3, Clock,
            ...
            <div className="flex items-center gap-3 px-3 py-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-white truncate">
                  {user?.firstName || user?.first_name || 'Center'} {user?.lastName || user?.last_name || 'Admin'}
                </p>
                <p className="text-xs text-gray-400 truncate">
                  {user?.role?.replace('_', ' ') || 'Center Admin'}
                </p>
              </div>
              <button
